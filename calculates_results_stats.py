...
def calculates_results_stats(results_dic):
    ...
    # Check if there are images before calculating percentages
    if len(results_dic) > 0:
        ...
        print("No images found for calculating statistics.")
        
    return results_stats_dic  # Make sure you return the dictionary
